...
└── plan/
    └── (quote generator — see plan/README.md)
```
...
- Copy config.js, logo.png and the 5 plan .webp images into `plan/` (see plan/README.md)
- Add the Apps Script token gate on ?action=leads before going live
- Link in the remaining internal tools
